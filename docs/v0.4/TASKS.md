...
Each task is a focused independently validated commit. Only V04-001 is in the current implementation
scope; later task descriptions are plans, not completed features.
