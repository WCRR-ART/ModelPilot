...
Each task is a focused independently validated commit. V04-001 and V04-002 are implemented;
V04-003 and later task descriptions remain plans, not completed features.
